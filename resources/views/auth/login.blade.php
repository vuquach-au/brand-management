...
<head>
  ...
  <body class="bg-light-gray" id="body">
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; 2018 Copyright Viking Dashboard Bootstrap Template by
          <a class="text-primary" href="http://www.vikingdigitalmarketing.com.au" target="_blank">Abdus</a>.
        </p>
      </div>
    </div>
</body>
